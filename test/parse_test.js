...
describe('Parse Record', function() {
  it('should parse eddystone beacon', function() {
    ...
    assert.equal(parsed.txPower, -33, 'txPower');
  });
  ...
  it('should parse uri beacon', function() {
    var data = [ 0x2, 0x1, 0x6,
      0x3, 0x3, 0xd8, 0xfe, // URIBeacon header
      0x13, // length -> 19
      0x16, // service data type value
      0xd8, 0xfe, // UUID
      0x0, // frame type
      0xfc, // TX power
      0x2, // URL scheme
      0x67, 0x6f, 0x6f, 0x2e, 0x67, 0x6c, 0x2f, 0x6b, 0x46, 0x45, 0x36, 0x65, 0x59, // Encoded URL
      0x0, 0x0, 0x0, 0x5a, 0x5a,
    ...
    assert.equal(parsed.txPower, -4, 'txPower');
  });
